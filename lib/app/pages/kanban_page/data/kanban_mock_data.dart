...
final List<TaskEmployee> taskEmployee = [
  ...
  TaskEmployee(
    ...
    imagePath:
    _userProfile.$2,    email: 'hwestiii@mac.com',
  ...
  TaskEmployee(
    ...
    imagePath:
    _userProfile.$3,    email: 'adamk@yahoo.com',
  ...
  TaskEmployee(
    ...
    imagePath:
    _userProfile.$4,    email: 'sumdumass@gmail.com',
  ...
  TaskEmployee(
    ...
    imagePath:
    _userProfile.$5,    email: 'kspiteri@live.com',
  ...
  TaskEmployee(
    ...
    imagePath:
    _userProfile.$6,    email: 'sinclair@att.net',
  ...
  TaskEmployee(
    ...
    imagePath:
    _userProfile.$7,    email: 'crowemojo@hotmail.com',
  ...
  TaskEmployee(
    ...
    imagePath:
    _userProfile.$8,    email: 'mobileip@mac.com',
  ...
  TaskEmployee(
    ...
    imagePath:
    _userProfile.$9,    email: 'dgatwood@msn.com',
  ...
  TaskEmployee(
    ...
    userName: 'Adeline Schinner',
    imagePath:
    _userProfile.$10,    email: 'bockelboy@att.net',
