...
import '../users_page/user_grid/demo_users.dart';
...
class _DataTableViewState extends State<DataTableView> {
                      ...
                      child: SingleChildScrollView(
                        ...
                        child: ConstrainedBox(
                          ...
                          child: ReorderableListView(
                            ...
                            children: [
                              for (int index = 0; index < employees.length; index++) _buildDataRow(employees[index], index),
                            ],
                          ),
                        ),
                      ),
        ...
        Container(
          ...
          child: Text(
            ...
            style: textTheme.bodyMedium?.copyWith(
              color: data.status == 'Active' ? AcnooAppColors.kSuccess : AcnooAppColors.kError,
            ),
          ),
        ),
      ),
  ...
  Widget _buildDataRow(Employee e, int index) {
    ...
    return Container(
      decoration: BoxDecoration(
        border: Border.all(color: theme.colorScheme.outline), // Border for separation
      ),
