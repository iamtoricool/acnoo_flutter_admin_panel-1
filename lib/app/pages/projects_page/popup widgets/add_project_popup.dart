...
class _AddProjectDialogState extends State<AddProjectDialog> {
  ...
  Future<void> _selectDate(BuildContext context, TextEditingController controller, ValueChanged<DateTime?> onDateSelected) async {
                        ...
                        decoration: InputDecoration(
                              ...
                              Wrap(
                                ...
                                children: _selectedEmployees.map((employee) {
                                  return Chip(
                                    avatar: CircleAvatar(
                                      radius: 15,
                                      backgroundImage: const NetworkImage('https://raw.githubusercontent.com/iamtoricool/static_images/main/avatars/placeholder_avatar/placeholder_avatar_01.png'),
                          ...
                          suffixIcon: DropdownButtonHideUnderline(
                            ...
                            child: DropdownButton<String>(
                              ...
                              onChanged: (newValue) {
                                if (newValue != null && !_selectedEmployees.contains(newValue)) {
                                  setState(() {
        ...
        Checkbox(
          ...
          onChanged: (bool? newValue) {
            if (newValue == true) {
              ...
              setState(() {
                _selectedValue = ''; // Deselect if it's the current selected one
              });
            }
          },
        ),
