...
class _AIChatDetailsViewState extends State<AIChatDetailsView> {
  ...
  final chatBotImage =
      'https://raw.githubusercontent.com/iamtoricool/static_images/main/avatars/placeholder_avatar/placeholder_avatar_06.png';
        ...
        children: [
          ...
          Container(
            decoration: BoxDecoration(
              border: Border(top: BorderSide(color: _theme.colorScheme.outline))
            ),
            padding: const EdgeInsets.symmetric(horizontal: 16, vertical: 8),
            child: TextField(
              controller: _messageEditingController,
