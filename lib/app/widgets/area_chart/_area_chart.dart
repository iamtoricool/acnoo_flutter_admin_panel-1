...
class _AreaChartState extends State<AreaChart> {
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              const Divider(thickness: 1,color: AcnooAppColors.kNeutral300,height: 1,),
              Expanded(
                child: Stack(
                  children: <Widget>[
                    Padding(
  ...
  LineChartData mainData() {
    final kReverzeSize = rf.ResponsiveValue<double?>(
        context,
        conditionalValues: [
          rf.Condition.smallerThan(name: BreakpointName.SM.name, value: 35),
        ],
        defaultValue: 50
    ).value??50;
    final bottomReverzeSize = rf.ResponsiveValue<double?>(
        context,
        conditionalValues: [
          rf.Condition.smallerThan(name: BreakpointName.SM.name, value: 20),
        ],
        defaultValue: 30
    ).value??30;
