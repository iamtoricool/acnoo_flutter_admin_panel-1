...
class _GeneralUsagesIncomeState extends State<GeneralUsagesIncome> {
  ...
  Widget build(BuildContext context) {
    ...
    final boxSize = rf.ResponsiveValue<double?>(context, defaultValue: 0, conditionalValues: [rf.Condition.largerThan(name: BreakpointName.XS.name, value: 24)]).value;
      ...
      child: Column(
        ...
        children: [
          ListTile(
            ...
            title: Text(
              'Daily Uses',
              style: theme.textTheme.titleLarge?.copyWith(fontSize: titleSize, fontWeight: FontWeight.w400, overflow: TextOverflow.ellipsis,color: theme.colorScheme.onTertiary),
            ),
            subtitle: Text(
              '60%',
              style: theme.textTheme.titleLarge?.copyWith(fontWeight: FontWeight.w600, fontSize: titleSize, overflow: TextOverflow.ellipsis,),
            ),
          ...
          ListTile(
            ...
            trailing: Wrap(
              ...
              children: valueList.entries.map(
                (entry) {
                  Color containerColor = entry.value > 70 ? AcnooAppColors.kPrimary600 : AcnooAppColors.kNeutral200;
                  return Container(
