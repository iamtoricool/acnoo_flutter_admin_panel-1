...
import '../../pages/widgets_page/general data/general_data_model.dart';
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        ...
                        style: textTheme.titleLarge?.copyWith(fontWeight: FontWeight.w600, fontSize: fontTitle),
                      ),
    ...
    return LineChartData(
      ...
      lineBarsData: [
        LineChartBarData(
          ...
          isCurved: true,
          gradient: gradient ?? LinearGradient(begin: Alignment.topCenter, end: Alignment.bottomCenter, colors: gradientColors),
          barWidth: 2,
          ...
          belowBarData: BarAreaData(
            ...
            gradient: LinearGradient(
              ...
              colors: (gradient?.colors ?? gradientColors).map((color) => color).toList(),
            ),
          ),
        ),
      ],
