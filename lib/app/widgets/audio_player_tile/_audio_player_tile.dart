  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      padding: responsiveValue<EdgeInsetsGeometry?>(
        context,
        xs: const EdgeInsets.symmetric(horizontal: 8, vertical: 5),
        md: const EdgeInsets.symmetric(horizontal: 16, vertical: 8),
      ),
      ...
      child: Row(
        children: [
          ...
          Padding(
            padding: responsiveValue<EdgeInsetsGeometry>(
              context,
              xs: const EdgeInsets.only(right: 6),
              md: const EdgeInsets.only(right: 10),
            ),
            child: Text.rich(
              TextSpan(
